...
emit_theme_css_vars() {
  ...
  :root {
    ...
    --border-color: #D1D9E0;
    --border-blockquote: #D1D9E0;
    --border-blockquote-left: #0969da;
    --text-primary: #1f2328;
    --text-body: #454C54;
    --text-paragraph: #59636E;
    --text-muted: #818B98;
    --text-code: #1f2328;
    --text-blockquote: #0550ae;
    --link-color: #0969da;
    --hr-color: #D1D9E0;
    --img-border: #D1D9E0;
    --badge-green-bg: #dafbe1; --badge-green-fg: #1a7f37;
    --badge-yellow-bg: #fff8c5; --badge-yellow-fg: #9a6700;
    --badge-orange-bg: #fff1e5; --badge-orange-fg: #bc4c00;
    --badge-red-bg: #ffebe9; --badge-red-fg: #d1242f;
    --fc-green-bg: #dafbe1; --fc-green-fg: #1a7f37;
    --fc-yellow-bg: #fff8c5; --fc-yellow-fg: #9a6700;
    --fc-orange-bg: #fff1e5; --fc-orange-fg: #bc4c00;
    --fc-red-bg: #ffebe9; --fc-red-fg: #d1242f;
  }
  [data-theme="dark"] {
    --bg-body: #0D1117;
    --bg-surface: #151B23;
    ...
    --bg-thead: #151B23;
    --bg-row-even: #151B23;
    --bg-blockquote: #151B23;
    --border-color: #3D444D;
    --border-blockquote: #3D444D;
    --border-blockquote-left: #58a6ff;
    --text-primary: #F0F6FC;
    --text-body: #D1D7E0;
    --text-paragraph: #9198A1;
    --text-muted: #656C76;
    --text-code: #D1D7E0;
    --text-blockquote: #58a6ff;
    --link-color: #58a6ff;
    --hr-color: #3D444D;
    --img-border: #3D444D;
    --badge-green-bg: #033a16; --badge-green-fg: #7ee787;
    --badge-yellow-bg: #422006; --badge-yellow-fg: #f2cc60;
    --badge-orange-bg: #431407; --badge-orange-fg: #fdba74;
    --badge-red-bg: #450a0a; --badge-red-fg: #fca5a5;
    --fc-green-bg: #033a16; --fc-green-fg: #7ee787;
    --fc-yellow-bg: #422006; --fc-yellow-fg: #f2cc60;
...
INDEX_HEAD_TOP
  ...
  :root {
    ...
    --sidebar-active-color: #0969da;
    --tool-bg: #ddf4ff;
    --tool-border: #80ccff;
    --tool-color: #0969da;
    --tool-hover-bg: #b6e3ff;
    --search-bg: #F6F8FA;
    --search-focus-bg: white;
    --count-bg: #F6F8FA;
    --doc-item-color: #59636E;
  }
  [data-theme="dark"] {
    --sidebar-bg: #151B23;
    --sidebar-hover: #212830;
    --sidebar-active-bg: #0c2d6b;
    --sidebar-active-color: #58a6ff;
    --tool-bg: #151B23;
    --tool-border: #3D444D;
    --tool-color: #58a6ff;
    --tool-hover-bg: #212830;
    --search-bg: #0D1117;
    --search-focus-bg: #151B23;
    --count-bg: #212830;
    --doc-item-color: #9198A1;
  }
